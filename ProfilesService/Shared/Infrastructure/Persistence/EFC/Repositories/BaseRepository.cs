...
{
    public abstract class BaseRepository<TEntity>(ProfilesContext context) : IBaseRepository<TEntity> where TEntity : class
    {
        protected readonly ProfilesContext Context = context;
